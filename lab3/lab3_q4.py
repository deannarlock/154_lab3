...
for cycle in range(12):
    if sim_trace.trace['op'][cycle] == 0:
        ...
        python_r = int("{0:02b}".format(sim_trace.trace['a'][cycle] + sim_trace.trace['b'][cycle])[0])
    python_cout = int("{0:02b}".format(sim_trace.trace['a'][cycle] + sim_trace.trace['b'][cycle])[1])
    if (python_r != sim_trace.trace['r'][cycle] or python_cout != sim_trace.trace['cout'][cycle]):
